...
import { ACCOUNT_MICROSOFT, ACCOUNT_MOJANG, ACCOUNT_DARK } from '../utils/constants';
    ...
    >
      <Container>
        ...
        >
          ...
          <StyledAccountMenuItem
            key={ACCOUNT_DARK}
            onClick={() => setAccountType(ACCOUNT_DARK)}
          >
            Login Account
          </StyledAccountMenuItem>
          <StyledAccountMenuItem
        ...
        {accountType === ACCOUNT_DARK ? renderAddDarkAccount() : null}
      </Container>
    </Modal>
  );
};
