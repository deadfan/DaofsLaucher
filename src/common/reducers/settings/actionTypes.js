...
export const UPDATE_CURSE_CHANNEL_LANG =
  'settings/UPDATE_CURSE_CHANNEL_LANG';
export const UPDATE_CURSE_CHANNEL_BACKGROUND =
  'settings/UPDATE_CURSE_CHANNEL_BACKGROUND';
