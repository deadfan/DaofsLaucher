...
// 0 это англиский , 1 это русский
function curseChannelLang(state = 0, action) {
  switch (action.type) {
    case ActionTypes.UPDATE_CURSE_CHANNEL_LANG:
      return action.curseChannelLang;
    default:
      return state;
  }
}
// 0 это 1 , 1 это 2
function curseChannelBackground(state = 2, action) {
  switch (action.type) {
    case ActionTypes.UPDATE_CURSE_CHANNEL_BACKGROUND:
      return action.curseChannelBackground;
    default:
      return state;
  }
}
