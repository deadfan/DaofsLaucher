...
export function updateCurseChannelLang(curseChannelLang) {
  return dispatch => {
    dispatch({
      type: ActionTypes.UPDATE_CURSE_CHANNEL_LANG,
      curseChannelLang
    });
  };
}

export function updateCurseChannelBackground(curseChannelBackground) {
  return dispatch => {
    dispatch({
      type: ActionTypes.UPDATE_CURSE_CHANNEL_BACKGROUND,
