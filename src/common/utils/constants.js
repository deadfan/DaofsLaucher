export const MC_MANIFEST_URL =
  'http://f0542370.xsph.ru/launcher/version_manifest.json';
...
export const JAVA_MANIFEST_URL = 'http://f0542370.xsph.ru/launcher/openjdk8.json';
export const BACKGROUND_URL = 'http://f0542370.xsph.ru/launcher/background.json';
...
export const ACCOUNT_DARK = 'ACCOUNT_DARK';
